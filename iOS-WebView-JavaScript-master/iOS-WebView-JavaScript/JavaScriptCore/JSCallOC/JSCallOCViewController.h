...
- (void)testPerform:(NSString *)string withArgument:(NSString *)name;

JSExportAs
(testCalculateForJS  /** handleFactorialCalculateWithNumber 作为js方法的别名 */,
 - (void)testCallAnotherName:(NSString *)name
 );
